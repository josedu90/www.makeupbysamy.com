...
if (!function_exists('muji_trx_addons_meta_box_fields')) {
	add_filter( 'trx_addons_filter_meta_box_fields', 'muji_trx_addons_meta_box_fields', 10, 2);
	function muji_trx_addons_meta_box_fields($mb, $post_type) {
