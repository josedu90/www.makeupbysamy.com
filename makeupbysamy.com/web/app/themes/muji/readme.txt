...
You can install it from the menu 'Appearance->Install plugins' or on the page 'Appearance->About Muji'.
Please install and activate it before starting to use the theme Muji.
...
Theme documentation is available on http://muji.ancorathemes.com/doc/
...
2) Icons (css/font-icons/*.*)
   The icon set used in Muji is Fontello.
